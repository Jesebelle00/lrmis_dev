    ...
    <div class="card">
        ...
        <div class="card-body">
            <ul class="list-group">
                ...
                <li class="list-group-item"><strong>Subject Shortcode:</strong> {{ $resource->subject_shorcode }}</li>
                <li class="list-group-item"><strong>Grade Level:</strong> {{ $resource->grade_level }}</li>
                <li class="list-group-item"><strong>Publisher Name:</strong> {{ $resource->publisher_name }}</li>
                <li class="list-group-item"><strong>Source Name:</strong> {{ $resource->source_name }}</li>
                <li class="list-group-item"><strong>Quantity:</strong> {{ $resource->qty }}</li>
            </ul>
        </div>
    </div>
</div>
