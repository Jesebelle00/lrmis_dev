...
<body class="g-sidenav-show  bg-gray-200">
  <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3   bg-gradient-white" id="sidenav-main">
   ...
   <div class="sidenav-header">
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
      ...
      <ul class="navbar-nav">
        <li class="nav-item">
          <a class="nav-link active text-dark  bg-gradient-warning" href="../lrmis/lrmis-dashboard_sdo.php">
        ...
        <li class="nav-item">
          <a class="nav-link text-dark" href="../lrmis/lrmis-addnew.php">
            <div class="text-center me-2 d-flex align-items-center justify-content-center text-dark">
        ...
        <li class="nav-item">
          <a class="nav-link text-dark" href="../lrmis/lrmis-tables.php">
            <div class="text-center me-2 d-flex align-items-center justify-content-center text-dark">
        ...
        <li class="nav-item">
          <a class="nav-link text-dark" href="../lrmis/lrmis-borrowers.php">
            <div class="text-center me-2 d-flex align-items-center justify-content-center text-dark">
        ...
        <li class="nav-item">
          <a class="nav-link text-dark" href="../lrmis/lrmis-generate.php">
            <div class="text-center me-2 d-flex align-items-center justify-content-center text-dark">
        ...
        <li class="nav-item">
          <a class="nav-link text-dark" href="../lrmis/lrmis-profile.php">
            <div class="text-center me-2 d-flex align-items-center justify-content-center text-dark">
	...
	<!-- Top User Heading ---------------------------------------------------------------------------------->
        <div class="sidenav-footer position-absolute w-100 bottom-0 ">
	     <div class="mx-3" style="text-align:center;">
  		<img src="sdo.png" alt="Schools Division of Naga" style="max-width:60%; height:auto;" padding-top: 100px;>
	     </div>
		...
		<div class="collapse navbar-collapse mt-sm-0 mt-2 me-md-0 me-sm-4" id="navbar">
          ...
          <ul class="navbar-nav  justify-content-end">
            <li class="nav-item d-flex align-items-center">
              <a href="../lrmis/logout.php" class="nav-link text-body font-weight-bold px-0">
   ...
   <div class="row">
      ...
      <div class="col-xl-3 col-sm-6 mb-xl-0 mb-4" style="width:400px; height:auto;">
		...
		<div id="SubjectLR"><?php require_once 'sdo/chartjsbarchart.php'; ?></div>		        
              ...
              <hr class="dark horizontal my-0">
              <div class="card-footer p-3">
             	  <p class="mb-0"><span class="text-success text-sm font-weight-bolder">Last Update: </span><?php require_once 'lrmislastupdate.php'; ?></p>
              </div>
 ...
 <div class="row" style="margin-top:10px;">
		...
		<div><?php require_once 'sdo/ratiotable.php'; ?></div>
	        </div>
	<!--
	      <div class="card-footer p-3">
